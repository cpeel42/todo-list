...
let cards = document.querySelector('.todo-cards');
cards.appendChild(new Card(testTodo1).card);
cards.appendChild(new Card(testTodo2).card);
cards.appendChild(new Card(testTodo3).card);
